...
type ErrorCode = 'UNSUPPORTED_SOURCE_DOMAIN' | 'SOURCE_URL_MISSING' | 'SOURCE_FETCH_FAILED' | 'SOURCE_TIMEOUT' | 'SOURCE_TOO_LARGE' | 'SOURCE_EMPTY' | 'SOURCE_PARSE_FAILED' | 'SOURCE_BLOCKED' | 'SOURCE_NOT_FOUND'
