...
const candidateFacts = {
  ...
  required: ['totalExperienceYears', 'experienceEntries', 'experienceAreas', 'skills', 'responsibilities', 'domains', 'achievements', 'languages', 'education', 'certifications'],
  properties: {
...
export function isCvProfileOutput(value: unknown): boolean {
  ...
  const factArrays = ['experienceEntries', 'experienceAreas', 'skills', 'responsibilities', 'domains', 'achievements', 'languages', 'education', 'certifications']
