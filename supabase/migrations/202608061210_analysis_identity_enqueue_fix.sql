-- Recovery V2 Phase 4 correction: remove the PL/pgSQL/column name ambiguity
...
begin
  ...
  v_analysis_identity := public.workspace_analysis_identity(actor_id, p_offer_id, current_offer_version_id, current_profile_version_id, 'jobmatch-job-match-v1', 'gpt-5.4-mini', 'jobmatch-deterministic-r1');
