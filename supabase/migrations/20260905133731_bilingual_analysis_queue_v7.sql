-- Bilingual analyses use a distinct queue identity so an ordinary new run
-- cannot reuse a Polish-only v6 result. Existing analysis versions and history
-- remain untouched and can be localized independently.
