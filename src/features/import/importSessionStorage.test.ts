...
const report: ImportedReport = { version: 1, source: 'rocketjobs-eml', fileName: 'report.eml', importedAt: '2026-07-28T10:00:00.000Z', offers: [{ id: 'offer-abc123', title: 'Data Analyst', company: 'Example', missingFields: [], warnings: [] }], warnings: [] }
